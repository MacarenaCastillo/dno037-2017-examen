...
<footer class="text-center">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="footer-col col-xs-6">
                    ...
                    <p.small>Freelance is a free to use, open source Bootstrap <br>theme created by <a href="http://startbootstrap.com">Start Bootstrap</a>.</p.small>
                </div>
            </div>
        </div>
    </div>
    <div class="footer-below">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p.small>Copyright &copy; MC Design Port 2017 - Macarena Castillo<p.small>
                </div>
            </div>
        </div>
    </div>
